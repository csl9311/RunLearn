...
<div class="sidebar w3-bar-block  w3-card" style="width:180px; margin-top:3px;">
  ...
  <button id="tablink2" class="w3-bar-item tablink hoverpink w3-round  hotpink fontwhite" onclick="sideTab(event, 'sideTabs2', 'tablink2');" style="width:175px">회원관리</button>
