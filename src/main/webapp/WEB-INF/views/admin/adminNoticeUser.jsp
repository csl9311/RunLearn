...
<div class="sidebar w3-bar-block  w3-card" style="width:180px; margin-top:3px;">
  ...
  <button id="tablink5" class="w3-bar-item tablink hoverpink w3-round hotpink fontwhite" onclick="sideTab(event, 'sideTabs5', 'tablink5');" style="width:175px">고객센터(요청)</button>
