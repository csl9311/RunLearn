...
<div class="sidebar w3-bar-block  w3-card" style="width:180px; margin-top:3px;">
  ...
  <button id="tablink8" class="w3-bar-item tablink hoverpink w3-round hotpink fontwhite" onclick="sideTab(event, 'sideTabs8', 'tablink8');" style="width:175px">(작업용)게시판작성</button>
</div>
