		...
		<div class="container" id="entry2" style="background: white; color: black;">
			<div class="row">
				<div id="left">
					...
					<div class="input1">
						<label>이메일:</label>
						<input type="email" placeholder="이메일을 입력해주세요." name="m_email" value="${ loginUser.m_name }" style="width: 80%;">
				...
				<div id="right">
					...
					<br>
					<br>
					<img src="#" width="300px" height="300px" id="image123" style="background: white"> <br> <br>
					<div id="button2">
						<input name="uploadFile" class="btn" type="file" value="파일찾기" accept="image/gif, image/jpeg, image/png" onchange="LoadImg(value);">
					</div>
				</div>
				<!-- right끝 -->
			</div>
