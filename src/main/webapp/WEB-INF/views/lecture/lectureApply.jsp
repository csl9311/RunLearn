		...
		<form method="post" enctype="Multipart/form-data" action="lectureApply.le">
			<div style="margin-left: 100px; width: 1000px; height: 1000px;">
				...
				<div id="MainImg" align="center">
					<div id="button2">
						<input type='file' name="mainImage" id="MainImageId" accept="image/gif, image/jpeg, image/png" />
					</div>
					<img width="80%" id="mainImageThumb" style="background: white">
					<br> <br>
				</div>
				...
				<div style="width: 100%">
					...
					<div class="col-md-2 mb-3">
						<div style="height:40%;"></div>
						<button id="mapBtn" type="button" class="btn btn-secondary mb-3" onclick="mapOpen();">지도로 확인하기</button>
					</div>
					</div>
					<script>
