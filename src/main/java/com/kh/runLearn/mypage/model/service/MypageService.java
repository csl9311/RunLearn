...
public interface MypageService {
	...
	int selectPlistCount(String userId); // 상품 찜목록 수

	ArrayList<Map<String, String>> selectTuterLecturePageView(String userId, PageInfo pi); // 튜터페이지 목록

	int updateMember(Member m); //회원정보 수정

	int updateMember_Image(Member_Image mi); //회원 프로필 수정
